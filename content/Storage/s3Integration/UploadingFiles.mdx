...
You can upload files to a bucket with the `putObject` command through the [S3 Client](/Storage/s3Integration/CreatingAClientInstance).
You must also specify the name of the [name of the bucket](/Storage/s3Integration/FetchingBuckets) that will contain the file.
