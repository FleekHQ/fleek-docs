...
This url is derived from the name of the [bucket name](/StorageSDK/FetchingBuckets) and the [file's key](/StorageSDK/ListingTheContentOfBucket) and is formatted as follows:
