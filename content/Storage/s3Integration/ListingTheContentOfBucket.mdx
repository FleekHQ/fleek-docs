...
Files in a bucket can be listed provided an [S3 client instance](/Storage/s3Integration/CreatingAClientInstance) and a [bucket name](/Storage/s3Integration/FetchingBuckets).
