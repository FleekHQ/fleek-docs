...
Click Add ENS to add your personal ENS `.eth` domain, example `https://fleek.eth`, once your domain has been set we will check the domain and verify you are the owner or registrant of the ENS domain
