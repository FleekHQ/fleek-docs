...
You can now easily point an ENS domain to your IPFS site and have the content automatically update for future deployments. You can now easily point an ENS domain to your IPFS site and have the content automatically update for future deployments. Here is how to setup an ENS domain for your site:

## Deploying

Once your app is deployed on fleek go the menu that says settings, a new set of the menu would be listed by the left-hand side, clicking Domain Management and scrolling a bit would land you on the section that says ENS
