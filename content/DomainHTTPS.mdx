...
Fleek needs to be a controller of your ENS domain so we can automatically update your domains content hash when a site deployment succeeds. Click the `Set Fleek as Controller` warning to set this up:
