...
Each new website deployment by Fleek is deployed atomically, meaning that there will never be any inconsistencies when pushing new files or making changes to existing ones.
...
Simply set the base directory of your project to your github repository and define your build command. Fleek will run your build command and deploy the result whenever you push to your Git repo. 
