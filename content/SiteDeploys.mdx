...
Simply set the base directory of your project to your github repository and define your build command [SHOW EXAMPLE PICTURE HERE]. Terminal will run your build command and deploy the result whenever you push to your Git repo. 
