...
Indeed, *docs.fleek.co* is a great example of how you can easily deploy your documentation on IPFS with Fleek Hosting.

PS: We are using the [mkdocs framework](https://squidfunk.github.io/mkdocs-material/).